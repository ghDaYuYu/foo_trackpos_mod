#pragma once
#define COMPONENT_NAME_H "Track positioner mod"
#define COMPONENT_NAME_HC "Track Positioner Mod"
#define COMPONENT_DESC "Place a track after the current playing."
#define COMPONENT_NAME "foo_trackpos_mod"
